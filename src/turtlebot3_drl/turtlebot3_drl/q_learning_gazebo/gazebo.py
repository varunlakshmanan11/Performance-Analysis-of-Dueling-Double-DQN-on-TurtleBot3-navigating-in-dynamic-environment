...
from ..q_learning_environment.environment import ARENA_LENGTH, ARENA_WIDTH, ENABLE_DYNAMIC_GOALS
from ..q_learning_parameters.settings import ENABLE_TRUE_RANDOM_GOALS
    ...
    def __init__(self):
        ...
        ************************************************************"""
        ...
        self.entity_dir_path = (os.path.dirname(os.path.realpath(__file__))).replace(
            'turtlebot3_drl/lib/python3.8/site-packages/turtlebot3_drl/q_learning_gazebo',
