...
from ..q_learning_parameters.settings import ENABLE_BACKWARD, EPISODE_TIMEOUT_SECONDS, ENABLE_MOTOR_NOISE, UNKNOWN, SUCCESS, COLLISION_WALL, COLLISION_OBSTACLE, TIMEOUT, TUMBLE, \
...
class DRLEnvironment(Node):
    ...
    *******************************************************************************"""
    ...
    def odom_callback(self, msg):
        ...
        # Computing traveled distance for logging
